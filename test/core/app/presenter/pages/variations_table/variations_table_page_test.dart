...
import 'package:finances_app/app/presenter/pages/variations_table/components/components.dart';
...
import 'package:finances_app/app/presenter/pages/variations_table/variations_table_page.dart';
...
void main() {
  ...
  testWidgets(
    "Deve exibir o widget TableHeaderComponent quando "
    ...
    (WidgetTester tester) async {
      ...
      expect(loadWidget, findsNothing);
      expect(failureWidget, findsNothing);
      expect(tableHeaderComponent, findsOneWidget);
    },
  );
}
