...
class Inject {
  static initialize() {
    ...
    getIt.registerLazySingleton<VariationDataSource>(
      () => VariationDataSourceImpl(getIt()),
    );
    ...
    getIt.registerLazySingleton<VariationRepository>(
      () => VariationRepositoryImpl(getIt()),
    );
    ...
    getIt.registerLazySingleton<GetAllVariationsUseCase>(
      () => GetAllVariationsUseCaseImpl(getIt()),
    );
